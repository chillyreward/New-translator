        ...
        <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-6 md:space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <Link href="/translate" className="w-full md:w-auto">
              <Button className="w-full md:w-auto shadow-lg shadow-primary-500/20 py-6 md:py-2">New Translation</Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <Card className="lg:col-span-2 p-0 border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden flex flex-col bg-white dark:bg-slate-950 transition-colors">
              <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-white dark:bg-slate-950/50 transition-colors">
            ...
            {/* Phrasebook Section */}
            <Card className="p-0 border-slate-100 dark:border-slate-800 shadow-sm flex flex-col bg-white dark:bg-slate-950 transition-colors">
