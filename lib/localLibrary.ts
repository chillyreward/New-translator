 ...
 * Maps English input → { kikuyu translation, wav file path }
 * WAV filenames match exactly what's in /public/audio/chunks/
 * The kikuyu field shows the translation in the UI.
 * The wav field is what plays when user clicks Speak/Play.
 */
...
const LIBRARY: Record<string, LocalPhrase> = {
  ...
  "i an taking medicine":           { kikuyu: "Nĩnjĩĩ kũnyua dawa",                 wav: W("i an taking medicine.wav") },
